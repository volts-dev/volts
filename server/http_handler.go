...
var (
	WebHandlerType       = reflect.TypeOf(HttpHandler{})
...
// 100%返回TContentBody
func NewContentBody(hd *HttpHandler) (res *TContentBody) {
	res = &TContentBody{
		handler: hd,
	}
...
func NewParamsSet(hd *HttpHandler) *TParamsSet {
	return &TParamsSet{
...
func (self *HttpHandler) FinalCall(handler func(*HttpHandler)) {
	self.finalCall = handler // reflect.ValueOf(handler)
}

/*
func (self *HttpHandler) getPathParams() {
	// 获得正则字符做为Handler参数
...
func (self *HttpHandler) Request() *http.Request {
	return self.request
}
...
func (self *HttpHandler) IsDone() bool {
	return self.isDone
}

// the reflect model of Value
func (self *HttpHandler) ValueModel() reflect.Value {
	return self.val
}

// the reflect model of Type
func (self *HttpHandler) TypeModel() reflect.Type {
	return self.typ
}

//TODO 添加验证Request 防止多次解析
func (self *HttpHandler) MethodParams(blank ...bool) *TParamsSet {
	var useBlank bool
	if len(blank) > 0 {
		useBlank = blank[0]
	}
...
func (self *HttpHandler) PathParams() *TParamsSet {
	return self.pathParams
}

func (self *HttpHandler) Body() *TContentBody {
	if self.body == nil {
...
// 值由Router 赋予
//func (self *HttpHandler) setPathParams(name, val string) {
func (self *HttpHandler) setPathParams(p Params) {
...
/*
func (self *HttpHandler) UpdateSession() {
...
func (self *HttpHandler) _CtrlCount() int {
	return len(self.Route.Ctrls)
}

// 数据缓存供传递用
func (self *HttpHandler) Data() *TParamsSet {
	if self.data == nil {
...
func (self *HttpHandler) GetCookie(name, key string) (value string, err error) {
...
func (self *HttpHandler) IP() (res []string) {
...
func (self *HttpHandler) SetCookie(name string, value string, others ...interface{}) {
	var b bytes.Buffer
...
func (self *HttpHandler) SetHeader(unique bool, hdr string, val string) {
	if unique {
...
func (self *HttpHandler) Abort(status int, body string) {
	self.response.WriteHeader(status)
	self.response.Write([]byte(body))
	self.isDone = true
}

func (self *HttpHandler) Respond(content []byte) {
	self.Result = content
}

func (self *HttpHandler) RespondError(error string) {
...
func (self *HttpHandler) RespondByJson(data interface{}) {
...
// Ck
func (self *HttpHandler) Redirect(urlStr string, status ...int) {
...
func (self *HttpHandler) Download(file_path string) error {
...
func (self *HttpHandler) ServeFile(file_path string) {
...
func (self *HttpHandler) DelTemplateVar(key string) {
	delete(self.templateVar, key)
}

func (self *HttpHandler) GetTemplateVar() map[string]interface{} {
	return self.templateVar
}

// set the var of the template
func (self *HttpHandler) SetTemplateVar(key string, value interface{}) {
	self.templateVar[key] = value
}

// Responds with 404 Not Found
func (self *HttpHandler) RespondWithNotFound(message ...string) {
