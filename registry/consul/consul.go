...
func (c *consulRegistry) Deregister(s *registry.Service, opts ...registry.Option) error {
	if len(s.Nodes) == 0 {
...
func (m *consulRegistry) CurrentService() *registry.Service {
	return m.opts.Service
}
